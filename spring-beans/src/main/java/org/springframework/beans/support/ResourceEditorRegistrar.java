...
public class ResourceEditorRegistrar implements PropertyEditorRegistrar {
	 ...
	 * 用以下资源编辑器填充给定的{@code registry}:ResourceEditor, InputStreamEditor,
	 * InputSourceEditor, FileEditor, URLEditor, URIEditor, ClassEditor, ClassArrayEditor。
	 * 如果这个注册器已经配置了{@link ResourcePatternResolver}，那么还会注册一个ResourceArrayPropertyEditor。
	 ...
	 * 如果可能的话，覆盖默认编辑器(因为这是我们在这里真正要做的);否则，注册为自定义编辑器。
	 */
